...
from vic_save_puck.data.loader import load_games, load_merged
...
def fetch_weather_for_dates(dates: list[str]) -> dict:
    ...
    # Open-Meteo supports date ranges
...
def enrich_games(force_reload: bool = False) -> pd.DataFrame:
    ...
    games["is_holiday"] = False  # Can be enriched with specific dates
    holiday_dates = {
