...
def load_games(force_reload: bool = False) -> pd.DataFrame:
    ...
    for row in rows:
        ...
        # Detect header rows
        if col_b == "Event":
            # Extract season from date column header
        ...
        # Fix year issues: season 1 rows 19-34 have year 2024 but should be 2025
