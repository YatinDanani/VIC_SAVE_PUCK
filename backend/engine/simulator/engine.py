...
@dataclass
class NoiseConfig:
    demand_spike_stand: str | None = None
    demand_spike_factor: float = 1.0
    demand_spike_after_min: float = 20.0
    stand_outage: str | None = None
    stand_outage_start_min: float = 30.0
    stand_outage_end_min: float = 50.0
    global_volume_factor: float = 1.0


Observer = Callable[[GameEvent], None]
WindowObserver = Callable[[int, list[GameEvent]], None]
