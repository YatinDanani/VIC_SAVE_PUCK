...
# ── Game clock ───────────────────────────────────────────────────────────────
PERIOD_BOUNDARIES = {
    "P1_start": 0, "P1_end": 20,
    "INT1_start": 20, "INT1_end": 38,
    "P2_start": 38, "P2_end": 58,
    "INT2_start": 58, "INT2_end": 76,
    "P3_start": 76, "P3_end": 96,
}

TIME_WINDOWS = list(range(-30, 120, 10))

# ── WHL opponent metadata ────────────────────────────────────────────────────
OPPONENT_DISTANCE = {
    "Tri-City": 520, "TriCity": 520, "Wenatchee": 450,
    "Prince Albert": 2100, "Moose Jaw": 2000, "Saskatoon": 2100,
    "Kamloops": 600, "Seattle": 180, "Regina": 2200,
    "Kelowna": 480, "Vancouver": 110, "Prince George": 900,
    "Everett": 200, "Brandon": 2300, "SWC": 0,
    "Portland": 500, "Spokane": 580, "Penticton": 440,
    "Medicine Hat": 1500, "Edmonton": 1150, "Lethbridge": 1400,
    "Red Deer": 1250, "Calgary": 1100,
}

OPPONENT_DIVISION = {
    "Tri-City": "US", "TriCity": "US", "Wenatchee": "US",
    "Seattle": "US", "Everett": "US", "Portland": "US", "Spokane": "US",
    "Kamloops": "BC", "Kelowna": "BC", "Vancouver": "BC",
    "Prince George": "BC", "Penticton": "BC",
    "Prince Albert": "East", "Moose Jaw": "East", "Saskatoon": "East",
    "Regina": "East", "Brandon": "East", "SWC": "East",
    "Medicine Hat": "Central", "Edmonton": "Central",
    "Lethbridge": "Central", "Red Deer": "Central", "Calgary": "Central",
}

# ── Drift thresholds ─────────────────────────────────────────────────────────
DRIFT_VOLUME_THRESHOLD = 0.15
DRIFT_MIX_THRESHOLD = 0.10
DRIFT_TIMING_THRESHOLD = 0.20
DRIFT_MIN_SAMPLES = 5
